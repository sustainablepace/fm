...
describe('FixtureSchedulerRoundRobinTwoLegs', function(){
  describe('schedule', function(){
    it('returns fixtures in correct order', function(){
		...
		fixtures0.match.home.should.eql( teams[ 0 ] );
		fixtures0.match.away.should.eql( teams[ 3 ] );
		var fixtures1 = fixtures.rounds[ 0 ].fixtures[ 1 ];
		fixtures1.match.home.should.eql( teams[ 1 ] );
		fixtures1.match.away.should.eql( teams[ 2 ] );

		// Round 2
		fixtures.rounds[ 1 ].fixtures.should.be.an.Array.with.lengthOf( 2 );
		var fixtures0 = fixtures.rounds[ 1 ].fixtures[ 0 ];
		fixtures0.match.home.should.eql( teams[ 0 ] );
		fixtures0.match.away.should.eql( teams[ 1 ] );
		var fixtures1 = fixtures.rounds[ 1 ].fixtures[ 1 ];
		fixtures1.match.home.should.eql( teams[ 2 ] );
		fixtures1.match.away.should.eql( teams[ 3 ] );

		// Round 3
		fixtures.rounds[ 2 ].fixtures.should.be.an.Array.with.lengthOf( 2 );
		var fixtures0 = fixtures.rounds[ 2 ].fixtures[ 0 ];
		fixtures0.match.home.should.eql( teams[ 0 ] );
		fixtures0.match.away.should.eql( teams[ 2 ] );
		var fixtures1 = fixtures.rounds[ 2 ].fixtures[ 1 ];
		fixtures1.match.home.should.eql( teams[ 3 ] );
		fixtures1.match.away.should.eql( teams[ 1 ] );

		// Round 4
		fixtures.rounds[ 3 ].fixtures.should.be.an.Array.with.lengthOf( 2 );
		var fixtures0 = fixtures.rounds[ 3 ].fixtures[ 0 ];
		fixtures0.match.home.should.eql( teams[ 3 ] );
		fixtures0.match.away.should.eql( teams[ 0 ] );
		...
		fixtures0.match.home.should.eql( teams[ 1 ] );
		fixtures0.match.away.should.eql( teams[ 0 ] );
		...
		fixtures0.match.home.should.eql( teams[ 2 ] );
		fixtures0.match.away.should.eql( teams[ 0 ] );
